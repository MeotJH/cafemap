...
7. For intentionally horizontal drag/scroll areas, use edge fade when content overflows so the list does not end with a hard vertical cut.
...
- Badges, chips, and compact metadata labels should be close to rectangular with modest corner radii, usually 6-8px, unless an established component requires a capsule.
