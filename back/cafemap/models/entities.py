...
# ORM models for CafeMap domain entities.
...
class User(Base):
    # User account synced from Firebase auth.
...
class Menu(Base):
    # Menu metadata grouped under a brand.
...
class BrandMenuAggregate(Base):
    # Aggregated scores for a brand-menu pair.
