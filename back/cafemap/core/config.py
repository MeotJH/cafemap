...
S3_THUMBNAIL_PREFIX = os.getenv("S3_THUMBNAIL_PREFIX", "review-thumbnails")
...
REVIEW_MEDIA_LIMIT = 5
REVIEW_IMAGE_LIMIT = REVIEW_MEDIA_LIMIT
REVIEW_VIDEO_MAX_DURATION_MS = 30_000
