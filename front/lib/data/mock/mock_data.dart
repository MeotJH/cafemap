...
class MockDataSource {
  List<StoreRanking> storeRankings() => const [
    StoreRanking(
      ...
      quietnessScore: 4.2,
      seatComfortScore: 4.3,
      serviceScore: 4.5,
      atmosphereScore: 4.6,
      valueScore: 4.1,
      dessertScore: 4.1,
      personalizedScore: 4.5,
      personalizedReasons: ['조용함 4.2', '분위기 4.6'],
  ...
  List<BrandMenuRanking> rankings() => const [
    BrandMenuRanking(
      ...
      reviewCount: 248,
      highlightScoreA: 4.7,
      highlightLabelA: '커피 맛',
      highlightScoreB: 4.4,
      highlightLabelB: '서비스 만족도',
      imageUrl: '',
      brandLogoUrl: '',
    ),
    BrandMenuRanking(
